...
const showcase = [
  {
    title: "AksharSync Marketing Platform",
        ...
        {showcase.map((project, i) => (
          <div key={project.title} className={`animate-float${i % 2 === 0 ? '-slow' : '-delayed'}`}>
            <motion.a
              ...
              whileHover={{ y: -10 }}
              className="group block relative bg-white/60 backdrop-blur-md rounded-[2rem] p-4 shadow-sm border border-white/50 transition-all duration-300 hover:shadow-xl cursor-pointer"
            >
              <div className="relative overflow-hidden rounded-[1.5rem] aspect-[4/3]">
                ...
                <div className="absolute inset-0 bg-linear-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-between p-8">
