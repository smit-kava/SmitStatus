import { ExternalLink, X } from "@/components/ui/GlobalIcons";
...
export default function DetailDialog({
  ...
  useGSAP(() => {
    if (isOpen) {
      ...
      tl.to(".detail-backdrop", { opacity: 0, duration: 0.3 }, 0);
    }
  }, [isOpen]);
  ...
  return (
    <div ref={containerRef}>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
        ...
        <div
          onClick={onClose}
          className="detail-backdrop absolute inset-0 bg-[#000a14]/70 backdrop-blur-md"
        />

        {/* Dialog Container */}
        <div
          className="detail-dialog relative w-full max-w-lg bg-[#00172c] border rounded-2xl flex flex-col overflow-hidden shadow-2xl z-10"
